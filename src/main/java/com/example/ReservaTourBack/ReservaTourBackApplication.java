package com.example.ReservaTourBack;
...
public class ReservaTourBackApplication {

	public static void main(String[] args) {
		
		SpringApplication.run(ReservaTourBackApplication.class, args);
	...
	public CorsFilter corsFilter() {
		...
		corsConfiguration.setAllowedOrigins(Arrays.asList("http://localhost:4200", "http://192.168.1.6:4200", "https://reservatourfrontend.web.app"));
